        ...
        @if (Route::has('login'))
            <div class="p-6 text-right sm:fixed sm:top-0 sm:right-0">
                @auth
                    ...
                    <a href="{{ route('logout') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-indigo-500"
        ...
        <div class="p-6 mx-auto max-w-7xl lg:p-8">
            ...
            @auth
                <div class="mt-8 text-center">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Welcome to TALL Stack Tutorial!</h2>
                    <p class="text-gray-600 dark:text-gray-400 mb-6">You're logged in. Start exploring the features below.</p>
